...
FS size in mpconfigboard.mk set to 128
ROMFS size in nrfrjs_romfs.ld set to 64K

FLASH          0x00027000                  0x009d000
...
0c00000000   bootloader
0x00027000   app            uffaw
size=flash_size - head_size - part0_size - fs_size - bootloader_tail-size
0x000c4000   romfs_part0
0x000d4000   fs
0x000f4000   tail
